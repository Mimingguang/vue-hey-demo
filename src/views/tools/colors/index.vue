<template>
  <div class="colors warp-container">
    <div v-font="20" v-padding="10" class="colors-title">中国传统颜色
      <button v-tooltip class="h-btn h-btn-text" content="点击色块即可复制颜色"><i class="iconfont icon-info-circle" /></button>
    </div>
